...
List<Order> pedidosDeEjemplo() => [
      ...
      _pedido(
        ...
        lineas: [
          _linea('mini_burguer', 2,
              opciones: {'Queso o tocineta': 'Con queso'}, salsas: ['rosada']),
      ...
      _pedido(
        ...
        telefonoCliente: '300 555 0192',
        horaEstimada: '7:30 p. m.',
        domiciliarioId: 'repartidor@elparche.com',
        codigoEntrega: '1052',
        status: OrderStatus.listo,
        hace: const Duration(hours: 1, minutes: 5),
        metodoPago: 'Bancolombia',
        direccion: 'Calle 12 #8-24, casa 3',
        lineas: [
          _linea('chuzo_pollo_cerdo', 1,
              opciones: {'Elige tu opción': 'Cerdo'}),
          _linea('salchipapa_especial', 1, adiciones: ['ad_tocineta']),
        ],
      ),
      // TEMPORAL: pedidos asignados en cada etapa para probar la vista del
      // domiciliario mientras todavía no hay backend.
      _pedido(
        id: '1055',
        cliente: 'Mariana Gómez',
        telefonoCliente: '315 555 0147',
        horaEstimada: '7:45 p. m.',
        domiciliarioId: 'repartidor@elparche.com',
        codigoEntrega: '1055',
        status: OrderStatus.enLocal,
        hace: const Duration(minutes: 35),
        metodoPago: 'Efectivo contraentrega',
        direccion: 'Carrera 52 #18-09, apto 204',
        lineas: [
          _linea('hamburguesa_doble', 2, salsas: ['bbq']),
          _linea('gaseosa_flexi_400', 2, opciones: {'Sabor': 'Coca-Cola'}),
        ],
      ),
      _pedido(
        id: '1056',
        cliente: 'Andrés Rojas',
        telefonoCliente: '301 555 0168',
        horaEstimada: '8:00 p. m.',
        domiciliarioId: 'repartidor@elparche.com',
        codigoEntrega: '1056',
        status: OrderStatus.enCamino,
        hace: const Duration(minutes: 50),
        metodoPago: 'Nequi',
        direccion: 'Calle 24 #41-16, casa 6',
        lineas: [
          _linea('mini_burguer', 3,
              opciones: {'Queso o tocineta': 'Con tocineta'},
              adiciones: ['ad_tocineta']),
        ],
      ),
      _pedido(
        id: '1051',
        cliente: 'Julián Vélez',
        telefonoCliente: '310 555 0184',
        domiciliarioId: 'repartidor@elparche.com',
        codigoEntrega: '1051',
