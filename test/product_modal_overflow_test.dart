...
void main() {
  ...
  testWidgets('el modal de detalle de producto no desborda', (tester) async {
    ...
    // scrollUntilVisible para en cuanto el widget existe en el árbol, que
    // no es lo mismo que estar dentro de la pantalla: sin esto el tap cae
    // fuera de la ventana y no le llega a nadie.
    await tester.ensureVisible(find.text('Productos'));
    await tester.pumpAndSettle();
